...
public class UserStateException extends AuthenticationException {
     ...
     * 
     */
    private static final long serialVersionUID = -1392691516838992424L;
     ...
     *            信息描述
     */
    public UserStateException(String errorCode, String message) {
     ...
     *            信息描述
     */
    public UserStateException(String errorCode, String message, Throwable cause,
            boolean propertiesKey) {
        super(message, cause);
        this.setErrorCode(errorCode);
        this.setPropertiesKey(propertiesKey);
