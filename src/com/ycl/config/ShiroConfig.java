...
import com.ycl.shiro.UserRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(
        ...
        shiroFilterFactoryBean.setLoginUrl("/login/showlogin");
    ...
    public HashedCredentialsMatcher hashedCredentialsMatcher() {
        ...
        hashedCredentialsMatcher
                .setHashAlgorithmName(HashAlgorithmName.MD5.getValue());//散列算法:这里使用MD5算法;
        hashedCredentialsMatcher.setHashIterations(
            CommonConstants.NumberConstant.TWO.getValue());//散列的次数，比如散列两次，相当于 md5(md5(""));
